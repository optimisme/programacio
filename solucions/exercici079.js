...
let pantalles = {
    bosc: {
        ...
        nedar: [
            { accio: 'escriu', valor: 'Al riu hi ha cocodrils, venen i se\'t menjen' },
            { accio: 'codi', valor: 'joc.perdut = true' }
        ],
    },
    vall: {
        ...
        galopar: [
            { accio: 'escriu', valor: 'Pujes a la mula i vas fins a una ciutat' },
    ...
    muntanya: {
        ...
        dormir: [
            { accio: 'escriu', valor: 'Dorms tota la nit ...' },
            { accio: 'escriu', valor: 'Et lleves mort de fred i amb molta gana' },
            { accio: 'codi', valor: 'joc.gana = true' }
        ],
