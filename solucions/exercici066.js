...
async function main () {
    ...
    // Demana a l'usuari que afegeixi un text per a l'arxiu
    text = await prompt("Escriu més text, per afegir a l'arxiu: ")

    // Afegeix el nou text que ha escrit l'usuari a l'arxiu amb 
    // la funció 'afegeixArxiu', escriu 'await' abans de cridar la funció
    await afegeixArxiu(nomArxiu, text)
